...
$sql = "
	...
	SELECT web_sites.*, clients.email FROM web_sites  inner join clients on web_sites.clientId = clients.id
	where
	(url like '%justEtc%' or isJustEtc='1')
...
echo ("<table border='1' width='80%' align='center' cellspacing='0' cellpadding='0'>");
         ...
         echo("<tr>
             	...
             	<td><strong>Client Activated?<strong></td>
   ...
   if ($num_rows > 0){
         ...
         while ($i < $num_rows){
            ...
            */
             ...
             echo("<tr>
             	<td>
             		<form id='editWebSites$clientIdO' name='editWebSites$clientIdO' action='editJustEtc.php' method='POST'>
             	...
             	<td><input type='text' id='clientActivated' name='clientActivated' value='{$row['clientActivated']}' size='10'></td>
