...
<div style='width:1080px;position:absolute;left:160px;top:0px;'>
	...
	<form method = 'POST' action = "editClient.php" id = 'rows_offset' name = 'rows_offset' >
		   	...
		   	<tr>
		   		<td>
		    		...
		    		<select id='country' name='country' onchange = "rows_offset.submit()">
		    			...
		    			<option value='0' <?php if ($country == 'All') echo 'selected' ?> > Any
...
echo ("<table border='0' width='80%' align='center' cellspacing='2' cellpadding='0'>");
         echo("<tr><td colspan='21'><strong><span style='color:red'>Traffic Statistics for Some Recent Clients </span></strong>");
