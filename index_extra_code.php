		...
		<tr>
			...
			if ($result){
				...
				if ($num_rows > 0){
					...
					<iframe src='indexBase.php' width='90%' height='600'> </iframe>

			<br />
			<span><strong><a href='http://addserver.onlineservicescloud.com?fromTraffic=1'>Buy
			Traffic from us, Buy Website Visitors from us</a><strong></span><br />
