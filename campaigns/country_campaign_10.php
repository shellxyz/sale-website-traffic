...
<?php
	...
	$sql = " SELECT * FROM web_sites where remaining > 0 and isActive > 0 and isBonus = '0' and country in ('Germany') and is_freezed = 0 order by priority desc, accessed asc limit 1 ";
