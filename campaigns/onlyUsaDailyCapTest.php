...
<?php
	...
	//$sql = " SELECT * FROM web_sites where remaining > 0 and isActive > 0 and isBonus = '0' and country in ('USA','NA') and is_freezed = 0 and  order by priority desc, accessed asc limit 1 ";
	//$sql = " SELECT * FROM web_sites where id = 427 and is_freezed = 0 ";
	$sql = " SELECT * FROM web_sites where remaining > 0 and isActive > 0 and isBonus = '0' and country in ('USA','NA') and is_freezed = 0 order by priority desc, accessed asc limit 1 ";
