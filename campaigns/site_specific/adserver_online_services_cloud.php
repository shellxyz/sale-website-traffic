...
<?php
	...
	if (isset($_GET['country'])){
		...
		//$countriesArr = implode();
	}
	$sql = " SELECT * FROM web_sites where remaining > 0 and isActive > 0 and isBonus = '0' and country in ('$countries', 'All') and is_freezed = 0 order by priority desc, country desc, accessed asc limit 1 ";
	//echo $sql;
	...
	if ($result){
	   ...
	   if ($num_rows > 0){
            ...
            $justetcUrl = "http://adserver.onlineservicescloud.com?isCampaign=1";


?>

<iframe src='<?php echo $justetcUrl; ?>' width='95%' height='300'>
</iframe>
